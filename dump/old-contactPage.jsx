...
const PHONE_DISPLAY = "+91 70150 85556";
const PHONE_LINK = "tel:+917015085556";
const EMAIL = "sales@pentagonply.com";
...
const WHATSAPP_LINK = `https://wa.me/917015085556?text=${WHATSAPP_MESSAGE}`;
...
const nextSteps = [
  [
    ...
    "We review the product, application, quantity, specifications and delivery location.",
  ],
  [
    "02",
    "We Clarify the Details",
    "If information is missing, we contact you to understand the grade, size, thickness, finish or project need.",
  ],
  [
    "03",
    "We Discuss the Next Step",
    "Once the requirement is clear, we can discuss suitable available options and the appropriate commercial step.",
  ],
];
...
const productDirections = [
  [
    ...
    "Explore MR Grade Plywood and Blockboard according to the application, panel length, moisture conditions and finish.",
    "Discuss an Interior Requirement",
    "product",
  ],
  [
    "Moisture-Prone Applications",
    "Tell us where the material will be installed and the exposure expected so the appropriate grade can be discussed.",
    "Ask About Water Resistance",
    "product",
  ],
  [
    "Doors and Shutters",
    "Share the opening size, door type, thickness, preferred finish, quantity and internal or external use.",
    "Discuss Door Options",
    "product",
  ],
  [
    "Dealer and Bulk Supply",
    "Provide your market, product categories, estimated volume and delivery location.",
...
const faqs = [
  [
    "How can I request a product quotation?",
    "Select Product Enquiry or Project or Bulk Requirement and share the product, size, thickness, quantity and delivery location. If you do not know every specification, describe the intended application.",
  ],
  [
    "Can I send my requirement on WhatsApp?",
    `Yes. The currently published WhatsApp number is ${PHONE_DISPLAY}. Include the product, quantity and delivery city, and attach any useful reference image or document.`,
  ],
  [
    "Can I enquire about becoming a dealer or distributor?",
    "Yes. Select Dealer or Distributor and provide your business name, market location, current product categories and territory.",
  ],
  [
    "Can architects, builders and interior designers submit a BOQ?",
    "Yes. The form accepts a specification, drawing, BOQ or reference document. Confirm the final file-size requirements with our team if the document is large.",
  ],
  [
    "Can I visit the Pentagon manufacturing location?",
    "The published address is Village Raipur, Khajuri Road, Yamunanagar, Haryana 135001. Contact the team before visiting so the timing and appropriate representative can be confirmed.",
  ],
  [
    "Does Pentagon accept export enquiries?",
    "You may submit an export enquiry for review. Current export availability, markets and delivery terms will be confirmed by the Pentagon team for the specific requirement.",
  ],
  [
    "What information should I include?",
    "Where possible, include the product, grade, size, thickness, quantity, application, delivery location and required-by date.",
  ],
  [
    "When will I receive a response?",
    "Our team will review your requirement and contact you using your preferred method.",
  ],
];
...
function ContactPage() {
  ...
  const selectedType = useMemo(
    () =>
      enquiryTypes.find((item) => item.value === enquiryType) ||
      enquiryTypes[0],
    [enquiryType],
  );
  ...
  return (
    <div className="contact-page">
        ...
        <div className="container contact-hero-grid">
          <div className="contact-hero-copy">
            ...
            <p>
              ...
              interiors or a larger project? Share your requirement, and we’ll
              help you understand the relevant product options and current
              availability.
            </p>
            ...
            {submitted ? (
              <div className="contact-success" role="status">
                ...
                <p>
                  ...
                  will review the details and contact you using your preferred
                  method.
                </p>
              ...
              <>
                ...
                <p className="contact-form-intro">
                  ...
                  “Just Want to Connect?” selected and send a simple message.
                </p>

                <div
                  className="contact-purpose-picker"
                  role="group"
                ...
                >
                  {enquiryTypes.map((item) => (
                    <button
                      className={
                        item.value === enquiryType ? "is-selected" : ""
                      }
                      type="button"
                      key={item.value}
                      onClick={() => {
                      ...
                      aria-pressed={item.value === enquiryType}
                    >
                ...
                <div className="contact-purpose-summary">
                  <span aria-hidden="true">?</span>
                  <p>{selectedType.copy}</p>
                </div>

                {enquiryType === "product" && (
                  <div
                    className={`contact-form-grid contact-dynamic-fields${expanded ? " is-collapsed" : ""}`}
                  >
                    ...
                    <Field label="Product or grade">
                      <input type="text" placeholder="e.g. MR Grade Plywood" />
                    </Field>
                  ...
                  >
                    <Field label="Business name" required>
                      <input
                        type="text"
                        required
                        placeholder="Your firm or store"
                      />
                    </Field>
                    <Field label="Operating city" required>
                      <input
                        type="text"
                        required
                    ...
                    <Field label="Current categories">
                      <input
                        type="text"
                        placeholder="Plywood, laminates, hardware…"
                      />
                    </Field>
                    <Field label="Market or territory">
                      <input
                        type="text"
                        placeholder="Areas you currently serve"
                      />
                    </Field>
                    <a
                      className="contact-partner-link is-wide"
                      href={ROUTES.dealers}
                    >
                      Review the dealer and distributor process <ArrowIcon />
                    </a>
                  </div>
                )}
                  ...
                  >
                    <Field label="Project type" required>
                      <input
                        type="text"
                        required
                        placeholder="Residential, office, hospitality…"
                      />
                    </Field>
                    ...
                    <Field label="Approximate quantity">
                      <input type="text" placeholder="If known" />
                    </Field>
                  ...
                  >
                    ...
                    <Field label="Required products" required>
                      <input
                        type="text"
                        required
                        placeholder="Products or grades"
                      />
                    </Field>
                    <Field label="Estimated quantity">
                      <input
                        type="text"
                        placeholder="Sheets, containers or volume"
                      />
                    </Field>
                ...
                {enquiryType === "general" && (
                  ...
                  >
                    ...
                    >
                      <input
                        type="text"
                        placeholder="A product, document, visit, partnership or something else"
                      />
                    </Field>
                    <Field label="Your message" required className="is-wide">
                      <textarea
                        rows="4"
                        required
                        placeholder="Write your question in your own words. Technical details are not required."
                      />
                    </Field>
                  </div>
                )}
                ...
                {expanded && (
                  <div className="contact-form-more">
                    ...
                    <div className="contact-form-grid">
                      ...
                      {enquiryType !== "general" && (
                        ...
                        >
                          <textarea
                            rows="3"
                            placeholder="Add application details, dimensions, delivery information or any useful context."
                          />
                        </Field>
                      )}
                      <Field label="Upload a reference" className="is-wide">
                        <input
                          type="file"
                          accept=".pdf,.xls,.xlsx,.doc,.docx,image/*"
                        />
                        <small>
                          Optional: PDF, BOQ, drawing, spreadsheet or reference
                          image.
                        </small>
                      </Field>
                    </div>
                    <label className="contact-consent">
                      ...
                      />
                      <span>
                        I agree that Pentagon Plywood Pvt. Ltd. may contact me
                        by phone, WhatsApp or email regarding this enquiry. My
                        information will be handled according to the{" "}
                        <a href={comingSoonUrl("Privacy policy")}>
                          Privacy Policy
                        </a>
                        .
                      </span>
                ...
                <p className="contact-form-footnote">
                  Only the fields relevant to your selected enquiry are shown.
      ...
      <section
        className="contact-section contact-enquiry-types"
        id="enquiry-types"
      >
        <div className="container">
          <SectionHeading
          ...
          <div className="contact-type-grid">
            {enquiryTypes.map((item) => (
              <article
                className={item.value === enquiryType ? "is-selected" : ""}
                key={item.value}
              >
                <button
                  className="contact-type-card-action"
                  type="button"
                  onClick={() => selectEnquiry(item.value)}
                  aria-label={`${item.action}: ${item.title}`}
                >
                  <div className="contact-type-top">
                    <span>{item.number}</span>
                    <i>↗</i>
                  </div>
                  <h3>{item.title}</h3>
                  <p>{item.copy}</p>
                  <span className="contact-type-action-label">
      ...
      <section className="contact-location" id="location">
        <div className="container contact-location-grid">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            aria-label="Open Pentagon Plywood location in Google Maps"
          >
      ...
      <section className="contact-section contact-direction">
        <div className="container">
          <SectionHeading
            ...
            title="Start With What You’re Planning to Make."
          />
          <div className="contact-direction-list">
            {productDirections.map(([title, copy, action, type], index) => (
              <article key={title}>
                ...
                <button type="button" onClick={() => selectEnquiry(type)}>
                  {action} <ArrowIcon />
                </button>
              </article>
            ))}
      ...
      <section className="contact-final">
        <div className="container">
          ...
          <div className="contact-final-actions">
            <a className="btn btn-primary" href={CONTACT_SECTIONS.form}>
