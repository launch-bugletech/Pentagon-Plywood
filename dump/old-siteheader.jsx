    ...
    <header className={`header${menuOpen ? ' mobile-menu-open' : ''}`}>
      <div className="topbar">
        <div className="container topbar-inner">
          ...
          <div>
            <a href="mailto:sales@pentagonply.com">
              sales@pentagonply.com
            </a>
            <a href="tel:+917015085556">+91 70150 85556</a>
          </div>
        </div>
      </div>
      <div className="container header-inner">
        ...
        <nav className="nav" aria-label="Main navigation">
          ...
          <div className={`nav-dropdown nav-products${openMenu === 'products' ? ' is-open' : ''}`}>
            ...
            <div className="nav-mega nav-mega-products">
          ...
          <div className={`nav-dropdown${openMenu === 'applications' ? ' is-open' : ''}`}>
          ...
          <div className={`nav-dropdown${openMenu === 'resources' ? ' is-open' : ''}`}>
            ...
            <div className="nav-mega nav-mega-compact nav-mega-resources">
              <div className="nav-mega-intro">
