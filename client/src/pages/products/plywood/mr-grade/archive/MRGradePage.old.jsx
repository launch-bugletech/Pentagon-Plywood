...
function Heading({ eyebrow, title, copy, light = false, className = "" }) {
  return (
    <div className={`max-w-3xl ${className}`}>
      <p
        className={`mb-4 text-xs font-bold uppercase tracking-[0.18em] ${light ? "text-[#E7B572]" : "text-[#9C6846]"}`}
      >
        {eyebrow}
      </p>
      <h2
      ...
      {copy && (
        <p
          className={`mt-5 max-w-2xl text-base leading-7 ${light ? "text-white/75" : "text-[#65736A]"}`}
        >
          {copy}
        </p>
      )}
  ...
  return (
    <div className="overflow-hidden bg-[#FDFBF8] text-[#14211A]">
      <section className="relative isolate overflow-hidden bg-[#1A1512] pb-12 text-white">
        <img
          src={heroRoomBg}
          alt="Interior bedroom with a wooden wardrobe"
        ...
        <div className={container}>
          ...
          >
            ...
            <span>Products</span>
            <span>›</span>
            <a className="transition hover:text-white" href={ROUTES.plywood}>
              Plywood
            </a>
            <span>›</span>
            <strong className="text-white">MR Grade Plywood</strong>
          </nav>
          <div className="grid items-center gap-10 pb-12 lg:grid-cols-[1.1fr_.9fr] lg:pb-20">
            <div className="max-w-2xl py-8 lg:py-14">
              ...
              <h1 className="font-['DM_Serif_Display',Georgia,serif] text-5xl leading-[.96] sm:text-6xl lg:text-7xl">
                ...
                <span className="text-[#E7B572]">for everyday interior</span>{" "}
                furniture.
              </h1>
          ...
          <div className="grid overflow-hidden rounded-2xl border border-white/15 bg-white/10 backdrop-blur sm:grid-cols-2 lg:grid-cols-4">
            {quickFactsData.map(({ label, value, icon }) => {
      ...
      <section id="overview" className={section}>
        <div
          className={`${container} grid items-center gap-10 lg:grid-cols-2 lg:gap-20`}
        >
          <figure className="overflow-hidden rounded-3xl bg-[#EDE5D9]">
            <img
              src={edgeImage}
              alt="Layered edge construction of plywood"
          ...
          <div>
            ...
            <div className="mt-7 space-y-4 leading-7 text-[#526057]">
              <p>
                <strong className="text-[#14211A]">
                  MR stands for Moisture Resistant.
                </strong>{" "}
                MR Grade Plywood is a general-purpose plywood intended primarily
                for furniture and interior applications.
              </p>
              <p>
                Multiple wood-veneer layers are bonded to create a balanced
                panel suitable for fabrication into furniture, cabinets,
                partitions and interior components.
              </p>
              <p>
            ...
            <div className="mt-6 rounded-2xl border-l-4 border-[#D99143] bg-[#F4EADD] p-5">
              <strong className="text-sm">Market terminology</strong>
            ...
            <a
              ...
              href={MR_GRADE_SECTIONS.enquiry}
            >
              Ask whether MR Grade fits my project <ArrowRight size={16} />
            </a>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#F4EADD] py-16 sm:py-20">
        <div className={container}>
          ...
          <div className="mt-10 grid gap-px overflow-hidden rounded-2xl border border-[#D7C5AE] bg-[#D7C5AE] md:grid-cols-3">
            {benefitsData.map(({ number, title, copy }) => (
              <article className="bg-[#FDFBF8] p-7" key={number}>
      ...
      <section id="applications" className={section}>
        <div className={container}>
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-2 xl:grid-cols-3">
            {applicationsData.map(({ title, copy, image, alt }, index) => (
              <article
              ...
              >
                ...
                <div
                  className={`absolute inset-0 ${image ? "bg-gradient-to-t from-[#14211A]/90 via-[#14211A]/20" : "bg-[#F4EADD]"}`}
                />
                <div
                  className={`relative flex h-full min-h-72 flex-col justify-end p-6 ${image ? "text-white" : "text-[#14211A]"}`}
                >
                  ...
                  <p
                    className={`mt-3 leading-6 ${image ? "text-white/80" : "text-[#65736A]"}`}
                  >
                    {copy}
                  </p>
                </div>
          ...
          <div className="mt-9 text-center">
            <a className={outlineButton} href={MR_GRADE_SECTIONS.thickness}>
              Find the Right Thickness <ArrowRight size={16} />
            </a>
          </div>
        </div>
      </section>
      ...
      >
        <div className={`${container} grid gap-10 lg:grid-cols-2 lg:gap-20`}>
          ...
          <div>
            ...
            >
              Compare Moisture-Resistant Options <ArrowRight size={16} />
            </a>
          </div>
        </div>
      </section>
        ...
        <div className={container}>
          ...
          <div className="mt-10 grid gap-8 lg:grid-cols-[1.2fr_.8fr]">
            <div className="overflow-hidden rounded-2xl border border-[#D9D3C8] bg-white">
              {specificationsData.map(([label, value]) => (
                <div
            ...
            <aside className="rounded-2xl bg-[#F4EADD] p-7">
              ...
              <h3 className="mt-3 font-['DM_Serif_Display',Georgia,serif] text-3xl">
                Verify certification before making the claim.
              </h3>
              ...
              >
                View quality information <ArrowRight size={16} />
              </a>
            </aside>
          </div>
        </div>
        ...
        <div className={container}>
          ...
          <div className="mt-10 overflow-x-auto rounded-2xl border border-[#D7C5AE] bg-white">
            <div className="min-w-[720px]">
              ...
              {thicknessesData.map(({ size, strength, use, duty }) => (
                <div
          ...
          <div className="mt-6 flex flex-col gap-5 rounded-2xl border border-[#D7C5AE] bg-white p-5 lg:flex-row lg:items-center">
            ...
            <a
              ...
              href={MR_GRADE_SECTIONS.enquiry}
            >
              Get Thickness Guidance <ArrowRight size={16} />
            </a>
          </div>
        </div>
      </section>
      ...
      <section id="grade-comparison" className={section}>
        <div className={container}>
          ...
          <div className="mt-9 text-center">
            <a className={darkButton} href={CONTACT_SECTIONS.form}>
              Help Me Compare Plywood <ArrowRight size={16} />
            </a>
          </div>
        </div>
      </section>
        ...
        >
          <figure className="overflow-hidden rounded-3xl">
            ...
            <figcaption className="bg-[#143D2B] px-5 py-4 text-xs font-bold uppercase tracking-[.12em] text-white/70">
              Plain surface · finish as required
            </figcaption>
          </figure>
          <div>
            <Heading
            ...
            />
            <p className="mt-6 leading-7 text-[#526057]">
            ...
            <ul className="mt-5 space-y-3">
              {fabricationChecksData.map((item) => (
                <li
                  className="flex gap-3 text-sm leading-6 text-[#526057]"
                  key={item}
                >
            ...
            <a
              ...
              href={MR_GRADE_SECTIONS.enquiry}
            >
              Discuss fabrication requirements <ArrowRight size={16} />
            </a>
          </div>
        </div>
      </section>
      ...
      <section id="quality" className="bg-[#143D2B] py-16 text-white sm:py-20">
        <div
          className={`${container} grid items-center gap-10 lg:grid-cols-[1.3fr_.7fr]`}
        >
          <div>
            <Heading
              light
            ...
            <div className="mt-6 max-w-2xl space-y-4 leading-7 text-white/75">
              <p>
                The Bureau of Indian Standards classifies general-purpose
                plywood under{" "}
                <strong className="text-white">IS 303:2024</strong>. The
                classification covers MR, BWR and BWP grades along with
                requirements for dimensions, workmanship, water-resistance
                testing, moisture content, strength and formaldehyde content.
              </p>
              <p>
            ...
            <a
              ...
              href={HOME_SECTIONS.quality}
            >
              View Quality & Certifications <ArrowRight size={16} />
            </a>
          </div>
          <div className="mx-auto grid aspect-square w-full max-w-xs place-items-center rounded-full border-[14px] border-[#D99143] text-center">
            <div>
              ...
              <small className="block text-sm tracking-[.2em]">2024</small>
              <p className="mt-4 text-sm text-white/70">
                General-purpose plywood standard
              </p>
      ...
      <section className={section}>
        <div className={container}>
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            {whyPentagonData.map(({ number, title, copy }) => (
              <article
        ...
        <div className={`${container} grid gap-10 lg:grid-cols-2`}>
          <div>
            <p className="text-xs font-bold uppercase tracking-[.18em] text-[#F4D8B4]">
              For Trade and Project Requirements
            </p>
      ...
      >
        <div className={`${container} grid gap-10 lg:grid-cols-[.85fr_1.15fr]`}>
          ...
          >
            ...
            <Field className="mt-4" label="Additional requirement">
              <textarea
                rows="4"
                placeholder="Dimensions, expected load, delivery location, timeline or any other useful detail…"
              />
            </Field>
            <button className={`${darkButton} mt-5 w-full`} type="submit">
              Send My Requirement <ArrowRight size={16} />
            </button>
            {sent && (
              <p
                className="mt-4 rounded-xl bg-[#E5F2E9] p-4 text-sm leading-6 text-[#143D2B]"
                role="status"
              >
...
function Field({ label, children, className = "" }) {
  return (
    <label className={`block text-sm font-semibold ${className}`}>
      <span>{label}</span>
      <div className="mt-2 [&_input]:w-full [&_input]:rounded-xl [&_input]:border [&_input]:border-[#D9D3C8] [&_input]:px-3 [&_input]:py-3 [&_input]:font-normal [&_input]:outline-none [&_input:focus]:border-[#9C6846] [&_select]:w-full [&_select]:rounded-xl [&_select]:border [&_select]:border-[#D9D3C8] [&_select]:bg-white [&_select]:px-3 [&_select]:py-3 [&_select]:font-normal [&_select]:outline-none [&_select:focus]:border-[#9C6846] [&_textarea]:w-full [&_textarea]:resize-y [&_textarea]:rounded-xl [&_textarea]:border [&_textarea]:border-[#D9D3C8] [&_textarea]:px-3 [&_textarea]:py-3 [&_textarea]:font-normal [&_textarea]:outline-none [&_textarea:focus]:border-[#9C6846]">
        {children}
      </div>
    </label>
  );
