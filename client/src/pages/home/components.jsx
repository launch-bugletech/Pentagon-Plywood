...
const Icon = {
  ...
  Calendar: () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6"><rect x="4" y="5" width="16" height="15" rx="2"/><path d="M8 3v4M16 3v4M4 10h16M8 14h2M14 14h2M8 17h2M14 17h2"/></svg>,
  Users: () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6"><circle cx="9" cy="8" r="3"/><circle cx="17" cy="9" r="2.5"/><path d="M3 20v-2a6 6 0 0 1 12 0v2M14 15a5 5 0 0 1 7 4v1"/></svg>,
};
  ...
  <section className="section" style={{background: 'var(--bg-alt)'}}>
    <div className="container">
      <div className="sec-head-single">
        <div className="eyebrow" style={{marginBottom: 20}}>Guided Selection</div>
  ...
  <section className="section">
    <div className="container">
      ...
      <div className="brand-spotlight">
        ...
        <div>
          <div className="eyebrow" style={{marginBottom: 20}}>Flagship Spotlight</div>
  ...
  <section id="manufacturing" className="mfg section">
    <div className="container">
      <div className="mfg-grid">
        ...
        <div>
          <div className="eyebrow" style={{marginBottom: 24}}>Manufacturing Excellence</div>
...
const Quality = () => (
  <section id="quality" className="section">
    <div className="container">
      <div className="sec-head-single">
        <div className="eyebrow" style={{marginBottom: 20}}>Quality & Certifications</div>
...
const apps = [
  ...
  { size: "med", label: "Commercial Offices", sub: "Partitions · Workstations", ph: "modern office joinery", image: officeImage, alt: "Open-plan office with plywood partitions and workstations" },
  { size: "sm", label: "Hospitality", sub: "Restaurants · Hotels", ph: "restaurant fit-out",  },
  { size: "med", label: "Retail Interiors", sub: "Displays · Kiosks", ph: "retail store fit-out", image: retailImage, alt: "Retail store interior with plywood displays" },
  { size: "sm", label: "Institutional", sub: "Schools · Colleges", ph: "institutional interior", },
  { size: "wide", label: "Modular Kitchens & Baths", sub: "Wet areas · Cabinetry", ph: "modular kitchen build", image: modularImage, alt: "Modular kitchen with plywood cabinetry" },
];
          ...
          <div className={`app-tile ${a.size}`} key={i}>
            <div className="app-tile-ph">
              {a.image || appFallbackImages[a.label]
                ? <img src={a.image || appFallbackImages[a.label]} alt={a.alt || `${a.label} interior`} loading="lazy" />
...
const Testimonials = () => (
  <section className="section" style={{background: 'var(--bg-alt)'}}>
    <div className="container">
      <div className="sec-head-single">
        <div className="eyebrow" style={{marginBottom: 20}}>From Our Partners</div>
