...
function OurStoryPage() {
  return (
    <div className="bg-[#FDFBF8] text-[#14211A]">
        ...
        <div className={c}>
          ...
          <div className="max-w-4xl py-16 sm:py-24">
            ...
            <h1 className="mt-5 font-['DM_Serif_Display',Georgia,serif] text-5xl leading-[.95] sm:text-6xl">
              ...
              <span className="text-[#E7B572]">Integrated Manufacturing.</span>
            </h1>
            ...
            <a
              className="mt-8 inline-flex items-center gap-2 rounded-full bg-[#D99143] px-5 py-3 text-sm font-bold text-[#14211A]"
          ...
          <div className="mt-8 border-l border-[#D7C5AE] pl-6 sm:pl-10">
            {timeline.map(([year, title, copy], i) => (
              <article className="relative pb-9 last:pb-0" key={title}>
                ...
                <p className="text-xs font-bold tracking-[.15em] text-[#9C6846]">
                  {year}
                </p>
                <h2 className="mt-2 font-['DM_Serif_Display',Georgia,serif] text-2xl">
                  {title}
                </h2>
          ...
          <ul className="grid gap-3 sm:grid-cols-2">
            {[
              ...
              <li className="flex gap-3 text-sm" key={x}>
                <Check className="shrink-0 text-[#9C6846]" size={18} />
                {x}
              </li>
            ))}
          </ul>
      ...
      <section className="py-16 sm:py-24">
        <div className={`${c} grid gap-10 lg:grid-cols-2`}>
          ...
          <div className="rounded-2xl border border-[#D9D3C8] bg-white p-7">
            <p>
              <strong className="block text-xl">Mr. Anand Jain</strong>
              <span className="text-[#65736A]">Managing Director</span>
            </p>
            <p className="mt-5">
              <strong className="block text-xl">Mr. Ashu Jain</strong>
              <span className="text-[#65736A]">Director</span>
            </p>
          </div>
        </div>
      </section>
      <section className="bg-[#143D2B] py-16 text-center text-white">
        <div className={c}>
          <h2 className="font-['DM_Serif_Display',Georgia,serif] text-4xl">
