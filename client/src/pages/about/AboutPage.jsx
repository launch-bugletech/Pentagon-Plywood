...
const ERAS = [
  {
    ...
    desc: "Began as timber trading merchants in Yamunanagar. Installed the first rotary peeling machines to convert raw wooden logs into high-grade veneers.",
    icon: Trees,
    milestones: [
  ...
  },
  {
    ...
    desc: "Pentagon Plywood Private Limited was incorporated in 1996. Integrated hydraulic hot pressing to convert processed veneers into finished plywood panels.",
    icon: Factory,
    milestones: [
  ...
  },
  {
    id: "era-3",
    period: "2017 – 2023",
    title: "Backward Integration into Chemicals",
    desc: "Acquired and expanded Formaldehyde resin chemical manufacturing units in Yamunanagar and Morbi (Gujarat), establishing complete raw material control.",
    icon: FlaskConical,
    milestones: [
