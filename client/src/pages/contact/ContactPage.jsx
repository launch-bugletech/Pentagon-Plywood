...
const PENTAGON_LOCATION = [
  77.28599938929692, // longitude
  30.099496445420478, // latitude
];
...
function IndiaMap() {
  ...
  useEffect(() => {
    ...
    map.once("load", () => {
      ...
      // Shift the factory upward because the information card covers
      // approximately 130px at the bottom.
      map.easeTo({
        center: PENTAGON_LOCATION,
        zoom: 12,
        padding: {
...
function FactoryLocationView() {
  ...
  return (
    <div className="contact-map-shell">
      ...
      {/* The iframe does not load until this becomes true */}
      {showFactoryView && (
        <div
            ...
            {submitted ? (
              ...
              <>
                ...
                <p className="contact-form-intro">
                  You do not need every technical specification. Tell us what
                  you know, and our team can continue the discussion.
                </p>
                ...
                {expanded && (
                  <div className="contact-form-more">
                    <div className="contact-form-step">
                      <span>02</span>
                      <strong>Tell us about the requirement</strong>
                    </div>
                    <div className="contact-form-grid">
                      <Field
                      ...
                      <Field label="Upload a reference" className="is-wide">
                        ...
                        />
                        <small>
                          Optional: PDF, spreadsheet, drawing or reference
                          image.
                        </small>
                      </Field>
                    </div>
                    ...
                    {enquiryType === "dealer" && (
                      <div className="contact-conditional">
                        <strong>Dealer or distributor details</strong>
                        <div className="contact-form-grid">
                          <Field label="Business name" required>
                            <input type="text" required />
                          </Field>
                          <Field label="City, district and state" required>
                            <input type="text" required />
                          </Field>
                          <Field label="Current product categories">
                            <input type="text" />
                          </Field>
                        ...
                        <a
                          ...
                          href={ROUTES.dealers}
                        >
                          Read about Pentagon’s dealer and distributor process{" "}
                          <ArrowIcon />
                        </a>
                      </div>
                    )}
                    ...
                    {enquiryType === "project" && (
                      <div className="contact-conditional">
                        ...
                        <div className="contact-form-grid">
                          ...
                          <Field label="Expected procurement date">
                            <input type="date" />
                          </Field>
                        </div>
                      </div>
                    ...
                    {enquiryType === "export" && (
                      <div className="contact-conditional">
                        <strong>Export requirement</strong>
                        <div className="contact-form-grid">
                ...
                >
                  {expanded
                    ? "Send My Requirement"
                    : "Continue Your Requirement"}{" "}
                  <ArrowIcon />
                </button>
                <p className="contact-form-footnote">
                  Fields marked * are required. Your entered information remains
                  in place if a field needs attention.
                </p>
              </>
            )}
          </form>
          ...
          <div className="contact-type-grid">
            {enquiryTypes.map((item) => (
              ...
              >
                ...
                <h3>{item.title}</h3>
                <p>{item.copy}</p>
                <button type="button" onClick={() => selectEnquiry(item.value)}>
