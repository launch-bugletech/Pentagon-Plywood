      ...
      {isOpen && (
        <div className="nav-mobile-leaves">
          {branch.children.map(([label, href]) => (
            <a href={href} key={label} onClick={onNavigate}>
              {label}
            </a>
          ))}
        </div>
...
function SiteHeader({ activePage = "home" }) {
  ...
  return (
    <>
      <div className="topbar">
        <div className="container topbar-inner">
          ...
          <div className="topbar-contact">
            <a href="mailto:sales@pentagonply.com" className="topbar-link">
              <svg
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
            ...
            <a href="tel:+917015085556" className="topbar-link">
              <svg
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
      ...
      <header
        ref={headerRef}
        className={`header ${isScrolled ? "is-scrolled" : "is-top"}${menuOpen ? " mobile-menu-open" : ""}`}
      >
        <div className="container header-inner">
          ...
          <nav className="nav" aria-label="Main navigation">
            <a
              href={ROUTES.home}
              className={activePage === "home" ? "nav-active" : undefined}
            ...
            <div
              className={`nav-dropdown${openMenu === "about" ? " is-open" : ""}`}
            ...
            >
              ...
              <div
                className="nav-mega nav-mega-compact"
                data-watermark="PENTAGON"
              >
                <div className="nav-mega-intro">
                  <span>About Pentagon</span>
                  <strong>
                    A manufacturing group built through steady expansion.
                  </strong>
                  <a href={ROUTES.about} onClick={closeMenu}>
                    About Pentagon <ArrowIcon />
                  </a>
                </div>
                <div className="nav-link-list">
                  <a href={ROUTES.ourStory} onClick={closeMenu}>
                    Our Story <ArrowIcon />
                  </a>
                  <a href={ROUTES.manufacturing} onClick={closeMenu}>
                    Manufacturing &amp; Infrastructure <ArrowIcon />
                  </a>
                  <a href={ROUTES.brands} onClick={closeMenu}>
                    Brands &amp; Trademarks <ArrowIcon />
                  </a>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div
                className="nav-mega nav-mega-products"
                data-watermark="MATERIALS"
              >
                <div className="nav-mega-intro">
                  <span>Product Portfolio</span>
                  <strong>
                    Made in-house. Sourced for the complete requirement.
                  </strong>
                  <a href={ROUTES.products} onClick={closeMenu}>
                    View all products <ArrowIcon />
                  </a>
                </div>
                <div className="nav-products-desktop">
                  <section className="nav-product-owner is-made">
                    <div className="nav-owner-heading">
                      <span>Made by Pentagon</span>
                      <a href={ROUTES.manufacturedProducts} onClick={closeMenu}>
                        Manufactured range <ArrowIcon />
                      </a>
                    </div>
                  ...
                  <section className="nav-product-owner is-sourced">
                    <div className="nav-owner-heading">
                      <span>Sourced by Pentagon</span>
                      <a href={ROUTES.tradedProducts} onClick={closeMenu}>
                        Traded range <ArrowIcon />
                      </a>
                    </div>
                    <div className="nav-owner-groups">
                ...
                <div className="nav-products-mobile">
                  <a
                    className="nav-mobile-all-products"
                  ...
                  <div className="nav-mobile-owner">
                    <button
                      type="button"
                      aria-expanded={Boolean(mobileProductOpen.manufactured)}
                      onClick={() => toggleMobileProductBranch("manufactured")}
                    >
                      <span>
                        <small>Made by Pentagon</small>Manufactured
                      </span>
                      <b aria-hidden="true">
                        {mobileProductOpen.manufactured ? "−" : "+"}
                      </b>
                    </button>
                    {mobileProductOpen.manufactured && (
                      <div className="nav-mobile-owner-content">
                        <a
                          className="nav-mobile-overview"
                          href={ROUTES.manufacturedProducts}
                          onClick={closeMenu}
                        >
                          Manufactured overview
                        </a>
                  ...
                  <div className="nav-mobile-owner is-sourced">
                    <button
                      type="button"
                      aria-expanded={Boolean(mobileProductOpen.sourced)}
                      onClick={() => toggleMobileProductBranch("sourced")}
                    >
                      <span>
                        <small>Sourced by Pentagon</small>Traded &amp; Sourced
                      </span>
                      <b aria-hidden="true">
                        {mobileProductOpen.sourced ? "−" : "+"}
                      </b>
                    </button>
                    {mobileProductOpen.sourced && (
                      <div className="nav-mobile-owner-content">
            ...
            >
              ...
              <div
                className="nav-mega nav-mega-compact"
                data-watermark="SPACES"
              >
                <div className="nav-mega-intro">
                  <span>Application Guide</span>
                  <strong>Start with the space you are making.</strong>
                  <a href={ROUTES.applications} onClick={closeMenu}>
                    Explore all applications <ArrowIcon />
                  </a>
                </div>
                <div className="nav-link-list">
            ...
            >
              ...
              <div
                className="nav-mega nav-mega-compact nav-mega-resources"
                data-watermark="KNOWLEDGE"
              >
                <div className="nav-mega-intro">
            ...
            <a
              href={ROUTES.dealers}
              className={activePage === "dealers" ? "nav-active" : undefined}
              aria-current={activePage === "dealers" ? "page" : undefined}
              onClick={closeMenu}
            >
              Dealers
            </a>
            <a
              href={ROUTES.contact}
              className={activePage === "contact" ? "nav-active" : undefined}
