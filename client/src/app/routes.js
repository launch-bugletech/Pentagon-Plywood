...
export const PRODUCT_ROUTES = Object.freeze({
  ...
  sourcedProducts: ROUTES.tradedProducts,
  decorativeMaterials: '/products/traded/decorative-materials',
  engineeredBoards: '/products/traded/engineered-boards',
  laminatedProducts: '/products/traded/laminated-products',
  laminates: '/products/traded/decorative-materials#laminates',
  teakPly: '/products/traded/decorative-materials#teak-ply',
  particleBoard: '/products/traded/engineered-boards#particle-board',
  wpcBoard: '/products/traded/engineered-boards#wpc-board',
  mdfBoard: '/products/traded/engineered-boards#mdf-board',
  hdhmrBoard: '/products/traded/engineered-boards#hdhmr-board',
  laminatedPlywood: '/products/traded/laminated-products#laminated-plywood',
  laminatedBlockboard: '/products/traded/laminated-products#laminated-blockboard',
  laminatedFlushDoors: '/products/traded/laminated-products#laminated-flush-doors',
});
